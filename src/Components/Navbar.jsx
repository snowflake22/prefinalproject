    ...
    return <div style={{ background: "#151033", color: 'white', position:'sticky', top:0, zIndex:100 }}>
        {
            global.login == 'true' ?
                <div className="container">
                    <div className="navbar navbar-dark bg-transparent">
                        <div className="navbar-brand">
                            <Text fontSize='xl' className="fw-bold" onClick={() => navigate('/homepage')}>Werrgram.</Text>
                        </div>
                                ...
                                <MenuList textColor='black' className="w-100 justify-content-end">
                                    {
                                        global.status == "VERIFIED" ?
                                            ...
                                            :
                                            <div>
                                                <MenuItem>Please verify your account to continue surfing Werrgram.</MenuItem>
                                                <Button colorScheme="white" variant="solid" className="ms-2 my-3 " onClick={handleResendLink}>Resend verification link</Button>
                                            </div>
                                    }
                                    <MenuDivider />
                        ...
                        <Modal isOpen={toggle} onClose={() => setToggle(!toggle)} size='xl'>
                            ...
                            <ModalContent className="p-3">
                                ...
                                <ModalFooter>
                                    {
                                        coba ? <Button colorScheme="blue" variant="solid" className="fw-bold" onClick={newPost} size='lg' >Post</Button>
                                            : <Button colorScheme="blue" variant="solid" className="fw-bold" disabled><Spinner size='sm' className="me-3" />Uploading</Button>
                                    }
                                </ModalFooter>
                            </ModalContent>
                        </Modal>
                ...
                <div className="container">
                    <div className="navbar navbar-dark bg-transparent">
                        <div className="navbar-brand">
                            <Text fontSize='xl' className="fw-bold" onClick={() => navigate('/')}>werrgram.</Text>
                        </div>
                        <div className="d-none d-md-flex align-items-center">
                            <Text fontSize='l' className="fw-bold me-3" style={{ color: 'white' }} onClick={() => navigate('/login')}>Sign In</Text>
                            <Button colorScheme="white" variant='outline' onClick={() => navigate('/register')}>Sign Up</Button>
                        </div>
