                        ...
                        <div className="card w-100" style={{ color: '#151033' }}>
                            ...
                            <FormControl className="px-3 pb-4 px-md-5 pb-md-5">
                                ...
                                <div className="d-flex justify-content-between mt-3 align-items-center mb-3">
                                    <Text className="fw-bold" color="blue" fontSize='sm' onClick={() => navigate('/forgotpassword')}>Forgot password?</Text>
                                    {
                                        coba ? <Button colorScheme="blue" variant="solid" onClick={onLogin}>Sign In</Button>
