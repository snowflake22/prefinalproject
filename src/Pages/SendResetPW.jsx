    ...
    return <div className="container">
        <div className="card w-50 m-auto my-5 p-5">
            <div className="card-body mt-3">
                <Text fontSize='2xl' className='card-title fw-bold pb-3 border-bottom border-lg-secondary' style={{ textAlign: 'center' }}>Werrgram</Text>
            ...
            {
                coba ? <Button className="mx-3 mb-5" size='sm' colorScheme="blue" variant="solid" onClick={sendLink}>Send Reset Password Link</Button>
                    : <Button className="mx-3 mb-5" size='sm' colorScheme="blue" variant="solid" disabled><Spinner size='sm' /></Button>
            }

            {/* <Button className="mx-3 mb-5" size='md' colorScheme="blue" onClick={sendLink}>Send Reset Password Link</Button> */}
        </div>
    </div>
}
