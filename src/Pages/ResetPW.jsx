        ...
        <div className="card w-50 m-auto my-5 p-5">
            {
                !successResult ?
                    <>
                        ...
                        {
                            coba ? <Button className="mx-3 mb-5" size='sm' colorScheme="blue" variant="solid" onClick={onReset}>Save password</Button>
                    ...
                    : <div>
                        ...
                        {
                            coba ? <Button className="mx-3 mb-5" size='sm' colorScheme="blue" variant="solid" onClick={handleResendLink}>Resend Reset Password Link</Button>
                                : <Button className="mx-3 mb-5" size='sm' colorScheme="blue" variant="solid" disabled><Spinner size='sm' /></Button>
                        }
                    </div>
            }
