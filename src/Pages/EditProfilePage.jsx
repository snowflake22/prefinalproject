...
const EditProfilePage = (props) => {
    ...
    console.log('Ini setprofpic', profpic)
    console.log('Ini global profpic', global.profilepic)
    console.log('Ini imagePreview', imagePreview)
                ...
                <div className="col-12 col-lg-9 align-items-center pe-4 border-start border-lg-secondary">
                    <form className="row g-3">
                        ...
                        <div className="col-8 mt-4">
                            ...
                            {
                                coba ? <Button className="mt-3" colorScheme="blue" variant="solid" onClick={onSubmit} disabled={fullname == false && bio == false && profpic == false && newUname == false || unameCheck == false ? true : false}>Submit</Button>

                                    : <Button colorScheme="blue" variant="solid" className="fw-bold mt-3" disabled><Spinner size='sm' className="me-3" />Submitting</Button>
                            }
                        </div>
                    </form>
                            ...
                            <ModalFooter>
                                {
                                    coba ?
                                        <div className="d-flex">
                                            ...
                                            <Button colorScheme="blue" variant="solid" className="fw-bold" onClick={() => setToggle(!toggle)} size='lg' >OK</Button>
                                        </div>
                                        :
                                        <div className="d-flex">
