...
const ProfilePage = () => {
    ...
    const printPost = () => {
        return data.map((val, idx) => {
            return <div className="col-4 my-4" key={val.idpost}>
                <div className="card">
                    <img className="myimg" src={API_URL + val.image} alt="imgHome" onClick={() => navigate(`/postpage/${val.idpost}`)}/>
                </div>
            </div>
        })
    }
                    ...
                    <div className="row py-5">
                        ...
                        global.status == "UNVERIFIED" ? */}
                            ...
                            printPost()
                                ...
                                {
                                    cobaResend ? <Button colorScheme="blue" variant="solid" onClick={handleResendLink}>Resend verification link</Button>
                                        : <Button colorScheme="blue" variant="solid" disabled><Spinner size='sm' /></Button>
                                }
                            </div>
